...
\begin{longtable}{L{0.98\linewidth}}
    Optimization for machine learning, convergence of iterative algorithms,
    gradient-based methods, convex liftings, variational analysis of machine learning models.
\end{longtable}
...
\begin{longtable}
    ...
    2025                & \textsc{Advisors:} Dr. Sahand Negahban and Dr. Deepak Rajan                    \\                  & {\small Focused on portfolio optimization. Received return offer.}                                                                                          \\ \multicolumn{2}{c}{} \\
...
\begin{longtable}
    ...
    2025 & \textbf{Best Poster}                                                               \\ & International Conference on Continuous Optimization (IICOPT) \\ & {\small  Awarded for the best student poster presentation at ICCOPT 2025. } \\ \multicolumn{2}{c}{} \\
...
\begin{longtable}{L{0.98\linewidth}}
    ``Optimal Sets and Solution Paths of ReLU Networks''. SIAM NCC25. October, 2025
    ...
    \\ \multicolumn{1}{c}{} \\
    ``SGD Under Interpolation: Convergence, Line-search, and Acceleration''. \href{https://meetings.siam.org/sess/dsp_programsess.cfm?SESSIONCODE=76238}{IAM OP23 Minisymposium on Adaptivity in Stochastic Optimization}, June 2023.
...
\begin{longtable}
    ...
    \vspace{0.3cm}2022-2025 & {\small Prepared homework and exam questions, held weekly office hours, and supervised assignment graders for a graduate-level class on convex optimization algorithms.} \\  \multicolumn{2}{c}{} \\
...
I have been a TMLR Expert Reviewer since 2024 and was an ICML Expert Reviewer
in 2021.
