...
\begin{longtable}
    {R{1.8cm}|p{11cm}}
    \textsc{2026}         & \textbf{PhD in Computer Science}, Stanford University          \\
...
\begin{longtable}
    {R{1.8cm}|L{11.8cm}}
    \multicolumn{2}{c}{\large \textbf{Postdoc} \hspace{11cm} }                                        \\
    \multicolumn{2}{c}{}                                                                              \\
    2026       & \textbf{Canada Postdoctoral Research Award Program (PDRA)} \hfill {(Declined)}       \\
               & Natural Sciences and Engineering Research Council of Canada (NSERC)                  \\
               & {\small  Two-year fellowship for post-doctoral scholars at Canadian
    institutions. }                                                                                   \\
    \multicolumn{2}{c}{}                                                                              \\
...
\begin{longtable}{C{0.1\linewidth} L{0.88\linewidth}}
    [ZWM26]     & Emi Zeger, Yifei Wang, \textbf{Aaron Mishkin}, Tolga Ergen, Emmanuel
...
\begin{longtable}{C{0.05\linewidth} L{0.93\linewidth}}
    \talknum &
    ``Global Optimization of Deep Relu Networks Using Convex Reformulations''. 
    SIAM Conference on Optimization (OP26),
    June 2026.
    \href{https://github.com/aaronpmishkin/talk-siam-op26}{[slides]}
    \\

    \multicolumn{2}{c}{} \\
    \talknum &
    ``Convex Analysis of Non-Convex Neural Networks''. Oxford Mathematical Institute,
    January 2026.
    \href{https://cs.stanford.edu/~amishkin/assets/slides/amishkin_phd_defense.pdf}{[slides]}
    \\
    \multicolumn{2}{c}{} \\

    \talknum &
    ``Level Set Teleportation: An Optimization Perspective''. EPFL MLO Group, January 2026.
    \href{https://github.com/aaronpmishkin/teleport-talk}{[slides]}
    \\
    \multicolumn{2}{c}{} \\

    \talknum &
    ``Convex Analysis of Non-Convex Neural Networks''. Inria Sierra Team,
    January 2026.
    \href{https://cs.stanford.edu/~amishkin/assets/slides/amishkin_phd_defense.pdf}{[slides]}
    \\
    \multicolumn{2}{c}{} \\
...
\textbf{Mentorship}: During my PhD, I volunteered for the Stanford student
application support program (SASP) and
was a mentor for the Stanford CS undergraduate mentorship program and
